...
$primary-font: 'Noto Sans TC', 'Helvetica Neue', Arial, Helvetica, sans-serif;
$primary-font-size: 14px;
$monospace-font: Menlo, Consolas, 'DejaVu Sans Mono', Courier, monospace;

$primary-background: #121212; //#0ff;

$secondary-background: #121212; //#ff0;
$secondary-background-selected: #efefef; //#e9e900;
$secondary-background-inactive: #f0f0f0; //#f0f000;
$secondary-background-hover: #e2e8f01a; //#dd0;
$secondary-background-disabled: #f9f9f9; //#fafa0;

$tertiary-background: #121212; //#f0f;

$shadow: rgba(0, 0, 0, 0.2);

// Main body text
$primary-text-color: #edeef1; //#0f0;
...
$primary-border-color: #ffffff33; //#f00;
$secondary-border-color: #121212; //#0f0;
$tertiary-border-color: #64748b; //#00f;
...
$form-input-border-selected-color: #32c9de; //#f0f;
...
$list-item-background-selected: #e2e8f01a; // #fff1e5;
$list-item-border-selected: $secondary-text-color-selected;

$tab-text-color-active: #16adc4;
...
$tab-background-active: #158ba540;
...
$tab-background-inactive: #121212;
...
$workspace-button-background: #121212;
$workspace-button-background-hover: #121212;
$workspace-button-background-active: #121212;

$workspace-button-color: $secondary-text-color;
$workspace-button-color-disabled: $secondary-text-color-disabled;
$workspace-button-color-focus: #16adc4;
$workspace-button-color-hover: #16adc4;
$workspace-button-color-active: #16adc4;
$workspace-button-color-selected: #16adc4;

$workspace-button-color-primary: #eee;
$workspace-button-background-primary: #158ba5;
$workspace-button-background-primary-hover: #158ba5;

$workspace-button-color-focus-outline: transparent;
...
$deploy-button-background: #158ba5;
$deploy-button-background-hover: #158ba5;
$deploy-button-background-active: #158ba5;
