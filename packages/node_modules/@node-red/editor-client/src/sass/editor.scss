...
.red-ui-group-layout-picker-cell-text {
    ...
    &.red-ui-group-layout-text-pos-nw {
        top: 0;
        left: 0;
    }
    &.red-ui-group-layout-text-pos-n {
        top: 0;
        left: calc(50% - 9px);
    }
    &.red-ui-group-layout-text-pos-ne {
        top: 0;
        right: 0;
    }
    &.red-ui-group-layout-text-pos-sw {
        bottom: 0;
        left: 0;
    }
    &.red-ui-group-layout-text-pos-s {
        bottom: 0;
        left: calc(50% - 9px);
    }
    &.red-ui-group-layout-text-pos-se {
        right: 0;
        bottom: 0;
    }
    &.red-ui-group-layout-text-pos- {
        ...
        background-image:
            linear-gradient(
                45deg,
                transparent 45%,
                var(--red-ui-secondary-border-color) 45%,
                var(--red-ui-secondary-border-color) 55%,
                transparent 55%,
                transparent
            ),
            linear-gradient(
...
.red-ui-editor-type-json-editor {
    ...
    .red-ui-treeList-label {
        ...
        &:hover,
        &:hover .red-ui-treeList-sublabel-text {
            ...
            input {
                ...
                &:focus {
                    box-shadow: 0 0 0 1px inset
                        var(--red-ui-form-input-focus-color);
                }
                &:first-child {
                    border-left: 1px solid var(--red-ui-secondary-border-color);
                }
